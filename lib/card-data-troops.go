...
var (
	// --- Common Troops ---
	KNIGHT = newCard(0, map[Attribute]interface{}{
		NAME:     "Knight",
		ARENA:    ARENA_0,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	ARCHERS = newCard(1, map[Attribute]interface{}{
		NAME:     "Archers",
		ARENA:    ARENA_0,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	BOMBER = newCard(2, map[Attribute]interface{}{
		NAME:      "Bomber",
		ARENA:     ARENA_0,
		RARITY:    COMMON,
		TYPE:      TROOP,
	...
	GOBLINS = newCard(10, map[Attribute]interface{}{
		NAME:     "Goblins",
		ARENA:    ARENA_1,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	SPEAR_GOBLINS = newCard(11, map[Attribute]interface{}{
		NAME:     "Spear Goblins",
		ARENA:    ARENA_1,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	SKELETONS = newCard(20, map[Attribute]interface{}{
		NAME:     "Skeletons",
		ARENA:    ARENA_2,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	MINIONS = newCard(21, map[Attribute]interface{}{
		NAME:     "Minions",
		ARENA:    ARENA_2,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	BARBARIANS = newCard(30, map[Attribute]interface{}{
		NAME:     "Barbarians",
		ARENA:    ARENA_3,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	MINION_HORDE = newCard(40, map[Attribute]interface{}{
		NAME:     "Minion Horde",
		ARENA:    ARENA_4,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	ROYALE_GIANT = newCard(70, map[Attribute]interface{}{
		NAME:     "Royale Giant",
		ARENA:    ARENA_7,
		RARITY:   COMMON,
		TYPE:     TROOP,
	...
	// --- Rare Troops ---
	GIANT = newCard(100, map[Attribute]interface{}{
		NAME:     "Giant",
		ARENA:    ARENA_0,
		RARITY:   RARE,
		TYPE:     TROOP,
	...
	MUSKETEER = newCard(101, map[Attribute]interface{}{
		NAME:     "Musketeer",
		ARENA:    ARENA_0,
		RARITY:   RARE,
		TYPE:     TROOP,
	...
	MINI_PEKKA = newCard(102, map[Attribute]interface{}{
		NAME:     "Mini P.E.K.K.A",
		ARENA:    ARENA_0,
		RARITY:   RARE,
		TYPE:     TROOP,
	...
	VALKYRIE = newCard(110, map[Attribute]interface{}{
		NAME:     "Valkyrie",
		ARENA:    ARENA_1,
		RARITY:   RARE,
		TYPE:     TROOP,
	...
	HOG_RIDER = newCard(140, map[Attribute]interface{}{
		NAME:     "Hog Rider",
		ARENA:    ARENA_4,
		RARITY:   RARE,
		TYPE:     TROOP,
	...
	WIZARD = newCard(150, map[Attribute]interface{}{
		NAME:      "Wizard",
		ARENA:     ARENA_5,
		RARITY:    RARE,
		TYPE:      TROOP,
	...
	THREE_MUSKETEERS = newCard(170, map[Attribute]interface{}{
	...
	// --- Epic Troops ---
	WITCH = newCard(200, map[Attribute]interface{}{
		NAME:        "Witch",
		ARENA:       ARENA_0,
		RARITY:      EPIC,
		TYPE:        TROOP,
	...
	SKELETON_ARMY = newCard(201, map[Attribute]interface{}{
		NAME:     "Skeleton Army",
		ARENA:    ARENA_0,
		RARITY:   EPIC,
		TYPE:     TROOP,
	...
	BABY_DRAGON = newCard(202, map[Attribute]interface{}{
		NAME:      "Baby Dragon",
		ARENA:     ARENA_0,
		RARITY:    EPIC,
		TYPE:      TROOP,
	...
	PRINCE = newCard(203, map[Attribute]interface{}{
		NAME:     "Prince",
		ARENA:    ARENA_0,
		RARITY:   EPIC,
		TYPE:     TROOP,
	...
	GIANT_SKELETON = newCard(220, map[Attribute]interface{}{
		NAME:      "Giant Skeleton",
		ARENA:     ARENA_2,
		RARITY:    EPIC,
		TYPE:      TROOP,
	...
	BALLOON = newCard(221, map[Attribute]interface{}{
		NAME:      "Balloon",
		ARENA:     ARENA_2,
		RARITY:    EPIC,
		TYPE:      TROOP,
	...
	PEKKA = newCard(240, map[Attribute]interface{}{
		NAME:     "P.E.K.K.A",
		ARENA:    ARENA_4,
		RARITY:   EPIC,
		TYPE:     TROOP,
	...
	GOLEM = newCard(260, map[Attribute]interface{}{
		NAME:      "Golem",
		ARENA:     ARENA_6,
		RARITY:    EPIC,
		TYPE:      TROOP,
	...
	DARK_PRINCE = newCard(270, map[Attribute]interface{}{
		NAME:      "Dark Prince",
		ARENA:     ARENA_7,
		RARITY:    EPIC,
		TYPE:      TROOP,
	...
	// --- Legendary Troops ---
	ICE_WIZARD = newCard(350, map[Attribute]interface{}{
		NAME:      "Ice Wizard",
		ARENA:     ARENA_5,
		RARITY:    LEGENDARY,
		TYPE:      TROOP,
	...
	PRINCESS = newCard(370, map[Attribute]interface{}{
		NAME:      "Princess",
		ARENA:     ARENA_7,
		RARITY:    LEGENDARY,
		TYPE:      TROOP,
