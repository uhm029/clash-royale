...
var (
	...
	BARBARIANS = Card{
		...
		COST:   5,
		HP:     []int{300, X, X, 399, 438, 480, 528, 579, 636, 699, 768, 843},
		DPS:    []int{50, X, X, 66, 72, 80, 88, 96, 106, 116, 128, 140},
		DAM:    []int{75, X, X, 99, 109, 120, 132, 144, 159, 174, 192, 210},
		HSPD:   1.5,
		TGTS:   GROUND,
		SPD:    MEDIUM,
		RNG:    MELEE,
	...
	GIANT = Card{
		...
		COST:   5,
		HP:     []int{2000, 2200, 2420, 2660, 2920, X, 3520, 3860, 4240, 4660},
		DPS:    []int{80, 88, 96, 106, 116, X, 140, 154, 169, 186},
		DAM:    []int{120, 132, 145, 159, 175, X, 221, 231, 254, 279},
		HSPD:   1.5,
		TGTS:   BUILDINGS,
		SPD:    SLOW,
		RNG:    MELEE,
	...
	MINI_PEKKA = Card{
		...
		COST:   4,
		HP:     []int{600, 660, 726, 798, 876, X, X, 1158, X, X},
	...
	VALKYRIE = Card{
		...
		DPS:    []int{73, X, X, 97, 106, X, X, 141, X, X},
	...
	PEKKA = Card{
		...
		DESC:   `A heavily...`,
		COST:   7,
		HP:     []int{2600, 2860, X, X, X, X, 4576, 5018},
		DPS:    []int{250, 275, X, X, X, X, 440, 482},
		DAM:    []int{450, 495, X, X, X, X, 792, 868},
		HSPD:   1.8,
		TGTS:   GROUND,
		SPD:    SLOW,
		RNG:    MELEE,
