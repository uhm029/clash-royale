...
var (
	...
	KNIGHT = newCard(0, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  3,
		attr.BaseHP:  600,
		attr.DPS:     []int{68, 74, 81, 90, 99, 109, 120, 130, 144, 158, 174, 190},
		attr.BaseDam: 75,
		attr.HSpeed:  1.1,
	...
	ARCHERS = newCard(1, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  3,
		attr.BaseHP:  125,
		attr.DPS:     []int{33, 36, 40, 44, 48, 53, 58, 64, 70, 77, 85, 93},
		attr.BaseDam: 40,
		attr.HSpeed:  1.2,
	...
	BOMBER = newCard(2, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   3,
		attr.BaseHP:   150,
		attr.DPS:      []int{52, 57, 63, 70, 76, 84, 92, 101, 111, 122, 134, 147},
		attr.BaseADam: 100,
		attr.HSpeed:   1.9,
		attr.Targets:  targets.Ground,
		attr.Speed:    speed.Medium,
	...
	GOBLINS = newCard(10, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  2,
		attr.BaseHP:  80,
		attr.DPS:     []int{45, 50, 54, 60, 66, 72, 80, 87, 96, 105, 116, 127},
		attr.BaseDam: 50,
		attr.HSpeed:  1.1,
		attr.Targets: targets.Ground,
	...
	SPEAR_GOBLINS = newCard(11, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  2,
		attr.BaseHP:  52,
		attr.DPS:     []int{18, 20, 22, 23, 26, 29, 32, 35, 38, 42, 46, 51},
		attr.BaseDam: 24,
		attr.HSpeed:  1.3,
		attr.Targets: targets.AirAndGround,
		attr.Speed:   speed.VeryFast,
	...
	BARBARIANS = newCard(30, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  5,
		attr.BaseHP:  300,
		attr.DPS:     []int{50, 54, 60, 66, 72, 80, 88, 96, 106, 116, 128, 140},
		attr.BaseDam: 75,
		attr.HSpeed:  1.5,
		attr.Targets: targets.Ground,
		attr.Speed:   speed.Medium,
	...
	ROYALE_GIANT = newCard(70, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  6,
		attr.BaseHP:  1200,
		attr.DPS:     []int{52, 56, 62, 68, 75, 83, 91, 100, 110, 122, 133, 146},
		attr.BaseDam: 78,
		attr.HSpeed:  1.5,
	...
	GIANT = newCard(100, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  5,
		attr.BaseHP:  2000,
		attr.DPS:     []int{84, 92, 101, 111, 122, 134, 147, 162, 177, 195},
		attr.BaseDam: 126,
		attr.HSpeed:  1.5,
		attr.Targets: targets.Buildings,
		attr.Speed:   speed.Slow,
	...
	MUSKETEER = newCard(101, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  4,
		attr.BaseHP:  340,
		attr.DPS:     []int{90, 100, 110, 120, 132, 145, 160, 175, 192, 211},
		attr.BaseDam: 100,
		attr.HSpeed:  1.1,
		attr.Targets: targets.AirAndGround,
		attr.Speed:   speed.Medium,
	...
	MINI_PEKKA = newCard(102, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  4,
		attr.BaseHP:  600,
		attr.DPS:     []int{180, 198, 218, 240, 263, 288, 317, 348, 382, 420},
		attr.BaseDam: 325,
		attr.HSpeed:  1.8,
		attr.Targets: targets.Ground,
		attr.Speed:   speed.Fast,
	...
	VALKYRIE = newCard(110, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  4,
		attr.BaseHP:  880,
		attr.DPS:     []int{80, 88, 96, 106, 116, 128, 140, 154, 169, 186},
		attr.BaseDam: 120,
		attr.HSpeed:  1.5,
		attr.Targets: targets.Ground,
		attr.Speed:   speed.Medium,
	...
	HOG_RIDER = newCard(140, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  4,
		attr.BaseHP:  800,
		attr.DPS:     []int{106, 117, 128, 141, 155, 170, 187, 205, 226, 248},
		attr.BaseDam: 160,
		attr.HSpeed:  1.5,
		attr.Targets: targets.Buildings,
		attr.Speed:   speed.VeryFast,
	...
	WIZARD = newCard(150, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   5,
		attr.BaseHP:   340,
		attr.DPS:      []int{76, 84, 92, 101, 111, 122, 134, 147, 161, 177},
		attr.BaseADam: 130,
		attr.HSpeed:   1.7,
		attr.Targets:  targets.AirAndGround,
		attr.Speed:    speed.Medium,
	...
	WITCH = newCard(200, map[attr.Attribute]interface{}{
		...
		attr.Elixir:    5,
		attr.BaseHP:    500,
		attr.DPS:       []int{54, 58, 64, 70, 78, 85, 94, 104},
		attr.BaseADam:  38,
		attr.BaseSkeLV: 6,
		attr.SSpeed:    7.5,
		attr.HSpeed:    0.7,
	...
	BABY_DRAGON = newCard(202, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   4,
		attr.BaseHP:   800,
		attr.DPS:      []int{55, 61, 67, 73, 81, 88, 97, 107},
		attr.BaseADam: 100,
		attr.HSpeed:   1.8,
		attr.Targets:  targets.AirAndGround,
		attr.Speed:    speed.Fast,
	...
	PRINCE = newCard(203, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  5,
		attr.BaseHP:  1100,
		attr.DPS:     []int{146, 161, 177, 194, 214, 234, 258, 282},
		attr.BaseDam: 220,
		attr.HSpeed:  1.5,
		attr.Targets: targets.Ground,
		attr.Speed:   speed.Medium,
	...
	GIANT_SKELETON = newCard(220, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   6,
		attr.BaseHP:   2000,
		attr.DPS:      []int{66, 73, 80, 88, 97, 106, 117, 128},
		attr.BaseDam:  100,
		attr.BaseDDam: 720,
		attr.HSpeed:   1.5,
		attr.Targets:  targets.Ground,
	...
	BALLOON = newCard(221, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   5,
		attr.BaseHP:   1050,
		attr.DPS:      []int{200, 220, 242, 266, 292, 320, 352, 386},
		attr.BaseDam:  600,
		attr.BaseDDam: 100,
		attr.HSpeed:   3,
		attr.Targets:  targets.Buildings,
	...
	PEKKA = newCard(240, map[attr.Attribute]interface{}{
		...
		attr.Elixir:  7,
		attr.BaseHP:  2600,
		attr.DPS:     []int{250, 275, 302, 332, 365, 400, 440, 482},
		attr.BaseDam: 450,
		attr.HSpeed:  1.8,
		attr.Targets: targets.Ground,
		attr.Speed:   speed.Slow,
	...
	GOLEM = newCard(260, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   8,
		attr.BaseHP:   3000,
		attr.DPS:      []int{74, 81, 90, 98, 108, 118, 130, 143},
		attr.BaseDam:  186,
		attr.BaseDDam: 186,
		attr.HSpeed:   2.5,
		attr.Targets:  targets.Buildings,
	...
	DARK_PRINCE = newCard(270, map[attr.Attribute]interface{}{
		...
		attr.BaseHP:   700,
		attr.BaseSHP:  200,
		attr.DPS:      []int{83, 91, 100, 110, 121, 133, 146, 159},
		attr.BaseADam: 125,
		attr.HSpeed:   1.5,
		attr.Targets:  targets.Ground,
		attr.Speed:    speed.Medium,
	...
	ICE_WIZARD = newCard(350, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   3,
		attr.BaseHP:   700,
		attr.DPS:      []int{42, 46, 50, 55, 60, 67},
		attr.BaseADam: 63,
		attr.HSpeed:   1.5,
		attr.Targets:  targets.AirAndGround,
		attr.Speed:    speed.Medium,
	...
	PRINCESS = newCard(370, map[attr.Attribute]interface{}{
		...
		attr.Elixir:   3,
		attr.BaseHP:   216,
		attr.DPS:      []int{46, 51, 56, 62, 68, 74},
		attr.BaseADam: 140,
		attr.HSpeed:   3,
		attr.Targets:  targets.AirAndGround,
		attr.Speed:    speed.Medium,
