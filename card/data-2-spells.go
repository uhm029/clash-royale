...
var spells = [...]card{
	...
	card{
		...
		attr.Elixir:   2,
		attr.BaseADam: 80,
		attr.CTDam:    []interface{}{32, 36, 39, 43, 47, 52, 56, 62, 68, 75, 82, 90, 99},
		attr.DurF:     1,
		attr.Radius:   2.5,
	}.init(),
	...
	card{
		...
		attr.Rarity:   rarity.Epic,
		attr.Type:     typ.Spell,
		attr.Desc:     `Increases troop movement and attack speed. Troop buildings and summoners deploy troops faster. Chaaaarge!`,
		attr.Elixir:   3,
